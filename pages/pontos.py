...
if "Nome Equipe" in df.columns:
   ...
   ranking.insert(9, "Projeção", ranking["Pontos"] + (media_pontos * dias_faltantes))

   ranking2.insert(0, "Posição", range(1, len(ranking) + 1))
   ranking2.insert(5, "Meta Dia | 300", (ranking["Pontos"] - 300) / dias_faltantes)
   ranking2.insert(6, "Meta Dia | 350", (ranking["Pontos"] - 350) / dias_faltantes)
   ranking2.insert(7, "Meta Dia | 375", (ranking["Pontos"] - 375) / dias_faltantes)
   ranking2.insert(8, "Meta Dia | 400", (ranking["Pontos"] - 400) / dias_faltantes)
   ranking2.insert(9, "Projeção", ranking["Pontos"] + (media_pontos * dias_faltantes))
